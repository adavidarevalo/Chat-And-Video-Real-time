...
import PhotoAttachment from '../../../../../../../components/chat/conversation/actions/attachments/menu/photo';
...
const meta = {
  title: 'Components/Chat/Conversation/Actions/Attachments/Menu/Photo Btn',

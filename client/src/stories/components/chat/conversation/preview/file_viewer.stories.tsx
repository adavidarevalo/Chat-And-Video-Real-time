...
import FileViewer from '../../../../../components/chat/conversation/preview/files/viewer';
...
const withProvider = () => {
  ...
  return (
    <Provider store={store}>
      <FileViewer activeIndex={0} />
    </Provider>
  );
};

const meta = {
  title: 'Components/Chat/Conversation/Preview/File Viewer',

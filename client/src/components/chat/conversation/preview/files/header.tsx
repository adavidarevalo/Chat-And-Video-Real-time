...
export default function HeaderFilesPreview({ activeIndex }: HeaderFilesPreviewProps) {
  ...
  return (
    <div className="w-full">
      <div className="w-full flex items-center justify-between">
        ...
        <h1 className="dark:text-dark_text_1 text-[15px]">{files[activeIndex]?.files?.name}</h1>
        <div></div>
      </div>
    </div>
  );
